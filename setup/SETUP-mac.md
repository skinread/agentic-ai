...
Setting up a powerful environment to work at the forefront of AI can be challenging. However, these instructions aim to be bullet-proof!
...
For this course, uv is the recommended package manager. It's blazingly fast and has really taken off in the Data Science world -- and for good reason.
...
Type `pwd` to see the current directory, and check you are in the 'agents' directory. For example, it could be `/Users/yourusername/projects/agents` and it should be something similar for you.
...
2. OpenAI asks for a minimum credit to use the API. In the US, it's \$5. The API calls will spend against this \$5. On this course, only a small portion of this will be used. Making this investment is recommended as you'll be able to put it to excellent use. Do keep in mind: Agentic systems are less predictable than traditional software engineering, and that's usually the intention! It also means there are some risks when it comes to costs. Set a fixed budget for your LLMs, and be sure to monitor costs carefully.

You can add your credit balance to OpenAI at Settings > Billing:  
https://platform.openai.com/settings/organization/billing/overview

It's recommended to **disable** the automatic recharge!
...
During the course, you'll also be directed to set up a number of other APIs that are free or very low cost.
...
Please do message me or email me at mike@syncopy.ai if this doesn't work or if I can help with anything. I can't wait to hear how you get on.